...
public abstract class PlayerSprite extends Sprite implements GeneralConstants{

	 public PlayerSprite(float pX, float pY, VertexBufferObjectManager vbo, Camera camera, PhysicsWorld physicsWorld, String name, int type)
	    {
	        super(pX, pY, ResourcesManager.getInstance().player1_region, vbo);
	        userdata=name;
	        playerType=type;
